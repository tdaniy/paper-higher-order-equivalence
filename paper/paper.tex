...
\begin{figure}[t]
\centering
\includegraphics[width=0.90\linewidth]{../experiment/kill_shot_rate_grid_tight_sqrt_log.png}
\vspace{0.4em}
\includegraphics[width=0.90\linewidth]{../experiment/kill_shot_rate_grid_tight_linear_log.png}
\vspace{0.4em}
\includegraphics[width=0.62\linewidth]{../experiment/kill_shot_rate_grid_tight_raw_p05_crop.png}
