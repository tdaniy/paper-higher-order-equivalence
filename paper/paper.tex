...
This can be read as an impossibility statement: within the reduced-information regular class, any design-valid equal-tailed interval that departs from the Gaussian pivot must forfeit CLT-order validity.
...
uniform remainder. This yields a reverse kernel $L_N$ with total-variation error $o(1)$.
