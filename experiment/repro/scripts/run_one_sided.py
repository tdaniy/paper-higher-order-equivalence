#!/usr/bin/env python3
"""Run only the one-sided calibration module at higher MC precision."""
...
from run_sim import run_one_sided, write_csv


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run one-sided calibration module")
