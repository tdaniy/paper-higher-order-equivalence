#!/usr/bin/env python3
"""Run deterministic parity module (fixed population per N)."""
...
from run_sim import run_parity_deterministic, write_csv


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run deterministic parity module")
...
def main() -> None:
    ...
    run_parity_deterministic(cfg["parity_deterministic"], seed, run_id, repro_root, master_rows, config_path, alpha)
