#!/usr/bin/env python3
"""Run skewed-treatment rate diagnostics (separate module)."""
...
from run_sim import run_skew_rate_diag, write_csv


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run skew-rate diagnostic module")
...
def main() -> None:
    ...
    run_skew_rate_diag(cfg["skew_rate_diag"], seed, run_id, repro_root, master_rows, config_path, alpha)
