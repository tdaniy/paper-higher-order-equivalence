#!/usr/bin/env python3
"""Run CRA sampling module only (writes master table)."""
...
from run_sim import run_cra_sampling, write_csv


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run CRA sampling module only")
